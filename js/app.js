    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
            ...
            <div class="weapper">
                ...
                <img src="images/weather_icons/${icon}.png" alt="${description}" width="64" height="64" class="weather-icon">
            </div>
                ...
                <div class="highlights-list">
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <div class="wrapper">
                            ...
                            <span class="title-1">${humidity}<sub>%</sub></span>
                        </div>
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <div class="wrapper">
                            ...
                            <span class="title-1">${pressure}<sub>hPa</sub></span>
                        </div>
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <div class="wrapper">
                            ...
                            <span class="title-1">${visibility / 1000}<sub>km</sub></span>
                        </div>
                    ...
                    <div class="card card-sm highlight-card">
                        ...
                        <div class="wrapper">
                            ...
                            <span class="title-1">${parseInt(feels_like)}&deg;<sup>c</sup></span>
                        </div>
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                tempLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        <img src="images/weather_icons/${icon}.png" alt="${description}" width="48" height="48"
